<template>
    <div class="itxst">
        <slot name="tbar"></slot>
        <ag-grid-vue :style="gridStyle" class="table ag-theme-balham" :columnDefs="columnDefs" :rowData="rowData"
            :gridOptions="mergedGridOptions" @gridReady="onGridReady" @cellClicked="onCellClicked">
        </ag-grid-vue>
        <slot name="bbar"></slot>
    </div>
</template>
